...
def run_test_better_draw_circles():
    print()
    print('--------------------------------------------------')
    print('Testing better draw_circles:  See graphics window')
    print('--------------------------------------------------')
...
def run_test_even_better_draw_circles():
    ...
    print('Testing better draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(7,100,300,20)
    even_better_draw_circles(4,50,59,30)


def even_better_draw_circles(n,a,b,c):
    window = rg.RoseWindow(400, 400)
