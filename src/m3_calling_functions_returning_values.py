...
def run_test_digits_in_power():
    ...
    # Test 2:
    expected1 = 9
    answer2 = digits_in_power(3,3)
    print("Test 2 expected:", expected1)
    print("       actual2: ", answer2)

    # Test 3:
    expected3 = 19
    answer3 = digits_in_power(4,6)
    print("Test 3 expected:", expected3)
    print("       actual3: ", answer3)
